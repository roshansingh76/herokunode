...
router.get("/", [helpers.loggedIn], function(req, res, next) {
  ...
  res.render("admin/category/index", { title: "Admin Category" });
});
...
router.get("/getCategory",[helpers.loggedIn], function(req, res, next) {
...
router.get("/searchCategory", [helpers.loggedIn], function(req, res, next) {
...
router.get("/editCategory/:id", [helpers.loggedIn], function(req, res, next) {
  Categories.findOne(
    {
      _id: req.params.id
    },
...
router.post("/updateCategory", [helpers.loggedIn], function(req, res, next) {
  var categoy = req.body.category;
  var slug = req.body.slug;
  var parentcategory = req.body.parentcategory;
  var document = {
...
router.get("/getParentcategory/:id", [helpers.loggedIn], function(
  req,
  res,
  next
) {
...
router.get("/deleteCategory/:id", [helpers.loggedIn], function(req, res, next) {
  Categories.remove(
    {
      _id: req.params.id
    },
